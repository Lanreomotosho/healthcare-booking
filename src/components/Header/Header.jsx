...
const Header = () => {
  ...
  <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      <button onClick={toggleMenu} type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none
       focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        Login</button>
     ...
     bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0
      ...
      <li>
        ...
        md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500
         ...
         md:dark:hover:bg-transparent dark:border-gray-700">Find a Doctor</a>
      </li>
