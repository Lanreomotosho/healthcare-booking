...
<div>
  <div className='lg:w-[570px]'>
    ...
    md:leading-[70px]'>Empowering Patients to Achieve Healthier, Longer Lives
    </h1>
    <p className='text__para'>We're dedicated to empowering patients for healthier, longer lives. Through personalized care and proactive strategies, we help individuals achieve their health goals and enhance their well-being. Join us on the journey to a healthier, longer life.
    </p>
...
{/*  ======== hero counter ========*/}
<div className='mt-[30px] lg:mt-[70px] xs:450px sm:640px md:768px flex flex-col lg:flex-row lg:items-center gap-5
lg:gap-[30px] '>
